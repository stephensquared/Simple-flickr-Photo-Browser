//
//  PhotoGalleryViewControllerTests.swift
...
class PhotoGalleryViewControllerTests: XCTestCase
{
    // MARK: Subject Under Test
    
    var sut: PhotoGalleryViewController!
    var window: UIWindow!
    ...
    func setupViewController()
    {
        ...
        sut = storyboard.instantiateViewController(withIdentifier: "PhotoGalleryViewControllerId") as! PhotoGalleryViewController
    }
